...
(crontab -l 2>/dev/null; echo "30 22 * * * docker run -i -t --rm -v /srv/shinyapps/RShiny_BiophysicalModelMap:/code yutaro/updates >> '/var/log/yutaro_app_updates.log' 2>&1") | crontab -
